...
<?php echo do_shortcode('[contact-form][contact-field label="Name" type="name" class="form-control" required="1"/][contact-field label="Email" class="form-control" type="email" required="1"/][contact-field label="Phone" class="form-control" type="phone"/][contact-field label="Comment" default="'. __('I would like to request more information about your','language').' '.$fields['year'].' '.$sorted_terms_child[1]->name.' '.$sorted_terms[0]->name.' '. __('with Stock Number #','language'). $fields['stock'].'" type="textarea" class="form-control" required="1"/][/contact-form] ');?> 
	<div style="clear:both"></div>
</div>
